  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: isSelected 
              ? (!isCorrect ? AppColors.onError : AppColors.green) 
              : Colors.transparent, 
          width: 2.0,
        ),
      ),
          ...
          child: Row(
            children: [
              isSelected 
                  ...
                  : Container(padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 6.0), child: Text(latter, style: AppStyles.caption.copyWith(fontWeight: FontWeight.bold))),
